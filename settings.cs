...
namespace Contacts2SQL
{
    public partial class settings : Form
    {
        ...
        public settings(MainForm P)
        {
            ...
            textBoxFilter.Text = Properties.Settings.Default.locationFilter;
            textBoxFolder.Text = Properties.Settings.Default.outlookPath;
        ...
        private void SaveSettings()
        {
            ...
            Properties.Settings.Default.locationFilter = textBoxFilter.Text;
            Properties.Settings.Default.outlookPath = textBoxFolder.Text;
        ...
        {
            MAPIFolder f = parentForm.objNS.PickFolder();

            textBoxFolder.Text = f.FolderPath;
        }
    }
}
